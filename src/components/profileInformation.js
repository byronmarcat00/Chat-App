...
const user = useSelector(state => state.user);
  ...
  return (
    <View>
      ...
      <InfoField theme={theme} label={"First Name"}
       canEdit value= {user.firstName} handleUpdate={updateUserFirstName}
...
function InfoField({
    ...
    return (
        <View style={styles.fieldContainer}>
            ...
            style ={{
                fontWeight:"500", color:Colors[theme.text], flexShrink:1
            }}
            />
